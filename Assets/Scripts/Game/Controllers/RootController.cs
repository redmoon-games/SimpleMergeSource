...
namespace Game.Controllers
{
    ...
    public class RootController : MonoBehaviour
    {
        ...
        private void OpenOfflineIncomeWindow()
        {
            ...
            BigValue reward = OfflineReward(incomePerSecond);

            offlineIncome.Closed += OnOfflineIncomeClosed;
            offlineIncome.TakenReward += () => walletService.TryAddGold(reward);
            
            offlineIncome.Init(reward);
            offlineIncome.Show();
        }
        ...
        private BigValue OfflineReward(BigValue incomePerSecond) =>
            _timestamp.PlayerAbsenceTime() > _gameSettings.maximumOfflineTime.Value ?
                CalculateReward(_gameSettings.maximumOfflineTime.Value, incomePerSecond) :
        ...
        private BigValue CalculateReward(TimeSpan playerAbsenceTime, BigValue incomePerSecond) =>
            (BigValue)incomePerSecond.Multiply(playerAbsenceTime.Seconds);
    }
}
