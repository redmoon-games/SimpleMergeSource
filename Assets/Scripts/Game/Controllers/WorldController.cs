...
namespace Game.Controllers
{
    ...
    public class WorldController : MonoBehaviour
    {
        ...
        public void Init(WorldData data)
        {
            ...
            if (_data.rooms == null) InitRoomData();
            InstantiateRooms();

            if (_data.metaGameData == null) InitMetaGameData();
            InstantiateMetaGameData();
        ...
        private void InstantiateMetaGameData()
        {
            _signalBus.Fire(new MetaGameDataNotificationSignal(_data));
        }

        private void InitMetaGameData()
        {
            _data.metaGameData = new MetaGameData();
        }
