...
namespace Game.Databases
{
    ...
    public class ResourceDatabase : ScriptableObject
    {
        ...
        public Sprite GetBuildingImage(string id) => buildingImages.GetBy(value => value.id == id).sprite;
        ...
        public void DownloadImages()
        {
            ...
            DownloadToList(new[] {"Assets/Sprites/UI/Sprites/00_ItemIcons"}, buildingImages);
